...
util.program.spawn_at_startup("wc-bg -f ~/Pictures/bg.jpg")
util.program.spawn_at_startup("fcitx")
--util.program.spawn_at_startup("polybar top")
...
way_cooler.windows = {
  ...
  borders = { -- Options for borders
    ...
    size = 0, -- The width of the borders between windows in pixels
...
local keys = {
  ...
  -- Open Google Chrome
  key({ mod }, "b", util.program.spawn_once("google-chrome")),

  -- Open terminal
  --key({ mod }, "t", util.program.spawn_once("env WAYLAND_DISPLAY= alacritty -e nvim -c ter")),
  key({ mod }, "t", util.program.spawn_once("env WAYLAND_DISPLAY= alacritty -e nvim -c ter")),

  -- Open Intellij Idea
  key({ mod }, "i", util.program.spawn_once("~/Downloads/idea-IU-173.3727.127/bin/idea.sh")),

  -- Open Postman
  key({ mod }, "p", util.program.spawn_once("~/Downloads/Postman/Postman")),
